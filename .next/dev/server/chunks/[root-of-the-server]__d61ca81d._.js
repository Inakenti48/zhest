...
async function GET() {
    try {
        const records = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
...
async function POST(request) {
    try {
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `).run(body.worker_id, body.date, body.status || 'present', body.check_in || null, body.check_out || null, body.note || '');
        const record = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('SELECT * FROM attendance WHERE id = ?').get(result.lastInsertRowid);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d61ca81d._.js.map