...
"[project]/src/app/api/work-logs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    `;
        ...
        const logs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(query).all(...params);
        const parsedLogs = logs.map((log)=>({
                ...log,
                products_made: log.products_made ? JSON.parse(log.products_made) : []
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(parsedLogs);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        if (!description) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Описание работы обязательно'
            }, {
                status: 400
            });
        }
        const productsArray = products_made || [];
        const totalItems = productsArray.reduce((sum, p)=>sum + (p.quantity || 0), 0);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cac23dd5._.js.map