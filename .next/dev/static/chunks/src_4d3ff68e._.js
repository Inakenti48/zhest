...
"[project]/src/components/OnlineOrdersClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OnlineOrdersClient({ initialOrders }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OnlineOrdersClient.useEffect": ()=>{
            const interval = setInterval({
                "OnlineOrdersClient.useEffect.interval": async ()=>{
                    try {
                        const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$de2142__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getOrders"])();
                        setOrders(updated);
                    } catch (error) {
                        console.error('Error updating orders:', error);
                    }
                }
            }["OnlineOrdersClient.useEffect.interval"], 5000);
            return ({
                "OnlineOrdersClient.useEffect": ()=>clearInterval(interval)
            })["OnlineOrdersClient.useEffect"];
        }
    }["OnlineOrdersClient.useEffect"], []);
    const handleStatusChange = async (id, newStatus, paymentMethod)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$bacbd5__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateOrderStatus"])(id, newStatus);
...
_s(OnlineOrdersClient, "ZYHH+c+7Rvq1hl2C/SD92j37EzA=");
_c = OnlineOrdersClient;
var _c;
__turbopack_context__.k.register(_c, "OnlineOrdersClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_4d3ff68e._.js.map