const SUPABASE_URL = 'https://hbsxbdkweqdqrkkmkhjd.supabase.co';
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imhic3hiZGt3ZXFkcXJra21raGpkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjgwMTgyODAsImV4cCI6MjA4MzU5NDI4MH0.QK_Hq23M897lsHDfw2fq3IGysbfhxkk8bLMG7HkwgV4';
...
async function seed() {
  console.log('Clearing products via REST...');
  ...
  console.log('Inserting products via REST...');
  ...
  if (res.ok) {
    console.log('Success! All products seeded via REST.');
  } else {
